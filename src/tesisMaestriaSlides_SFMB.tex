...
\newcommand*{\runninghead}{Maestría en Ciencias con Especialidad en
  Electrónica} % Running head displayed on
                                % almost all slides
\newcommand*{\myauthor}{Sergio-Feliciano Mendoza-Barrera} % Presenters name(s)
\newcommand*{\mydate}{Julio 29, 2014} % Presentation date
\newcommand*{\myuni}{Global Labs Mexico} % University or department
...
% \textit{Sed iaculis} dapibus gravida. Morbi sed tortor erat, nec
